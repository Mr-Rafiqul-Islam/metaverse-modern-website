...
function ExploreCard({ id, imgUrl, title, index, active, handleClick }) {
  return (
    ...
    >
      ...
      />
      {active !== id ? (
        <h3 className="font-semibold sm:text-[26px] text-[18px] text-white absolute lg:bottom-20 lg:-rotate-90 lg:origin-[0,0] z-0">
          {title}
        </h3>
      ) : (
        <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
          ...
          <p className="font-normal text-base leading-[24px] text-white uppercase ">Enter the Metaverse</p>
