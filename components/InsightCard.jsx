  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 1)} className="flex md:flex-row flex-col gap-4">
      ...
      <div className="w-full flex justify-between items-center gap-8">
        ...
        <div className='lg:flex hidden items-center justify-center rounded-full border border-white w-[100px] h-[100px] group'>
          <img src="/arrow.svg" alt="arrow" className="w-[40%] H-[40%] object-contain group-hover:rotate-[30deg] duration-300 cursor-pointer" />
        </div>
      </div>
    </motion.div>
  )
